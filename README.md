...
I have cloned this repo from @endor, to make some changes and add my own additions to the project.
...
-----
		...
		5. A local db store for caching?
		6. another option instead of modifying transmission itself is to allow the web ui to interface into	a small dameon to do some dirty work
